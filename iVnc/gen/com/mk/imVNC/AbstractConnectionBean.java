// This class was generated from com.mk.imVNC.IConnectionBean by a tool
...
public abstract class AbstractConnectionBean extends com.antlersoft.android.dbimpl.IdImplementationBase implements IConnectionBean {
    ...
    public static final int GEN_COUNT = 65;
    ...
    public int[] Gen_columnIndices(android.database.Cursor cursor) {
        ...
        result[31] = cursor.getColumnIndex(GEN_FIELD_PASSWORD);
        result[32] = cursor.getColumnIndex(GEN_FIELD_COLORMODEL);
        result[33] = cursor.getColumnIndex(GEN_FIELD_PREFENCODING);
        result[34] = cursor.getColumnIndex(GEN_FIELD_EXTRAKEYSTOGGLETYPE);
        result[35] = cursor.getColumnIndex(GEN_FIELD_FORCEFULL);
        result[36] = cursor.getColumnIndex(GEN_FIELD_REPEATERID);
        result[37] = cursor.getColumnIndex(GEN_FIELD_INPUTMODE);
        result[38] = cursor.getColumnIndex(GEN_FIELD_SCALEMODE);
        result[39] = cursor.getColumnIndex(GEN_FIELD_USEDPADASARROWS);
        result[40] = cursor.getColumnIndex(GEN_FIELD_ROTATEDPAD);
        result[41] = cursor.getColumnIndex(GEN_FIELD_USEPORTRAIT);
        result[42] = cursor.getColumnIndex(GEN_FIELD_USELOCALCURSOR);
        result[43] = cursor.getColumnIndex(GEN_FIELD_KEEPPASSWORD);
        result[44] = cursor.getColumnIndex(GEN_FIELD_FOLLOWMOUSE);
        result[45] = cursor.getColumnIndex(GEN_FIELD_USEREPEATER);
        result[46] = cursor.getColumnIndex(GEN_FIELD_METALISTID);
        result[47] = cursor.getColumnIndex(GEN_FIELD_LAST_META_KEY_ID);
        result[48] = cursor.getColumnIndex(GEN_FIELD_FOLLOWPAN);
        result[49] = cursor.getColumnIndex(GEN_FIELD_USERNAME);
        result[50] = cursor.getColumnIndex(GEN_FIELD_RDPDOMAIN);
        result[51] = cursor.getColumnIndex(GEN_FIELD_SECURECONNECTIONTYPE);
        result[52] = cursor.getColumnIndex(GEN_FIELD_SHOWZOOMBUTTONS);
        result[53] = cursor.getColumnIndex(GEN_FIELD_DOUBLE_TAP_ACTION);
        result[54] = cursor.getColumnIndex(GEN_FIELD_RDPRESTYPE);
        result[55] = cursor.getColumnIndex(GEN_FIELD_RDPWIDTH);
        result[56] = cursor.getColumnIndex(GEN_FIELD_RDPHEIGHT);
        result[57] = cursor.getColumnIndex(GEN_FIELD_RDPCOLOR);
        result[58] = cursor.getColumnIndex(GEN_FIELD_REMOTEFX);
        result[59] = cursor.getColumnIndex(GEN_FIELD_DESKTOPBACKGROUND);
        result[60] = cursor.getColumnIndex(GEN_FIELD_FONTSMOOTHING);
        result[61] = cursor.getColumnIndex(GEN_FIELD_DESKTOPCOMPOSITION);
        result[62] = cursor.getColumnIndex(GEN_FIELD_WINDOWCONTENTS);
        result[63] = cursor.getColumnIndex(GEN_FIELD_MENUANIMATION);
        result[64] = cursor.getColumnIndex(GEN_FIELD_VISUALSTYLES);
        return result;
    }
