...
class ZoomScaling extends AbstractScaling {
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#getDefaultHandlerId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#isAbleToPan()
	 */
	@Override
	boolean isAbleToPan() {
		return true;
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#isValidInputMode(int)
	 */
	@Override
...
//		return mode == R.id.itemInputTouchPanZoomMouse;
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#zoomIn(com.mk.imVNC.VncCanvasActivity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#getScale()
	 */
	@Override
	float getScale() {
		return scaling;
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#zoomOut(com.mk.imVNC.VncCanvasActivity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#adjust(com.mk.imVNC.VncCanvasActivity, float, float, float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractScaling#setScaleTypeForActivity(com.mk.imVNC.VncCanvasActivity)
	 */
	@Override
