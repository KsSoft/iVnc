...
import com.mk.android.drawing.OverlappingCopy;
import com.mk.android.drawing.RectList;
import com.mk.util.ObjectPool;
...
class LargeBitmapData extends AbstractBitmapData {
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#copyRect(android.graphics.Rect, android.graphics.Rect, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#drawRect(int, int, int, int, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#offset(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#scrollChanged(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#updateBitmap(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#updateBitmap(Bitmap, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#validDraw(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#prepareFullUpdateRequest(boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#syncScroll()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mk.imVNC.AbstractBitmapData#frameBufferSizeChanged(RfbProto)
	 */
	@Override
