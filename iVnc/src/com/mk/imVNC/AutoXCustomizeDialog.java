...
import com.mk.util.RandomString;
...
public class AutoXCustomizeDialog extends AlertDialog {
	...
	public AutoXCustomizeDialog(Context context) {
		...
		mainConfigDialog = (iVnc)context;
		selected = mainConfigDialog.getCurrentConnection();
		rnd = new RandomString();
	}

	private static final Intent docIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://mk.blogspot.ca/2012/10/looking-for-nx-client-for-android-or.html")); 
